...
require(scales)
require(grid)
Hybridpower(dir = "/Users/brendanwringe/Desktop/DFO Aquaculture Interaction/Test/", filetag = "Top192", Threshold = 0.7)


function(dir,filetag="",Threshold=NULL) {
...
dir = "/Users/brendanwringe/Desktop/DFO Aquaculture Interaction/Test/"
...
filedir <- dir
    ...
    # Collate the output from New Hybrids together ('p of z' files)
        ...
        for (i in lfiles)
        {
              ...
              numLociWorking <- gsub(x = numLociWorking, pattern = " loci", replacement = "")

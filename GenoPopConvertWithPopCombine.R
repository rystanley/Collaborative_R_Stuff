GenePop <- read.table("~/Desktop/DFO Aquaculture Interaction/South West Coast - NB Fish Merge/NL-Maritime Merge/CorrMaritimeSalmon.txt",header = FALSE, quote="", stringsAsFactors = FALSE, sep = "\t")
agPop <- TRUE
subs=NULL
keep=TRUE
sPop=NULL
agPopFrame <- read.csv("~/Desktop/DFO Aquaculture Interaction/R Function Create/NovaScotiaPopTable.csv", stringsAsFactors = FALSE)
dir <- "~/Desktop/DFO Aquaculture Interaction/R Function Create/NovaScotiaWildFarm.txt"
